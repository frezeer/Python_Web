...
class User(db.Model, UserMixin):
    ...
    #password = db.Column(db.String(93), nullable=False) hubo error con estas configuraciones
    ...
    def create_element(cls, username, password, email):
        ...
        return user
    #consultas tipo sql hacia la base de datos
    @classmethod
...
class Task(db.Model):
    ...
    update_ad = db.Column(db.DateTime,default=datetime.datetime.now())
